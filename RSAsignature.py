...
class Ui_rsasig(object):
    def setupUi(self, rsasig):
        ...
        self.rsaprikeyfile.setGeometry(QtCore.QRect(
            170, 70, 530, 31))  # 160, 50, 551, 31
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
        ...
        self.rsapubkeyfilechoose.setGeometry(
            QtCore.QRect(710, 23, 31, 31))  # 710, 10, 31, 31
        ...
        self.rsapubkeyfile.setGeometry(QtCore.QRect(
            170, 30, 530, 31))  # 160, 10, 551, 31
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(12)
